...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  if (!isExterior) {
    const interiorModifiers: Record<string, string> = {
      "Modern": "ultra-contemporary modern luxury bedroom with architectural precision, illuminated by soft natural daylight streaming through the original grand floor-to-ceiling windows which must remain visible and prominent. Sophisticated recessed LED perimeter lighting with warm white temperature creates ambient glow. Center the composition around a stunning low-profile platform bed with an integrated floating headboard in matte charcoal or warm taupe high-gloss lacquered finish, dressed with premium monochromatic bedding in shades of grey and white, accented by a single bold jewel-tone throw pillow in emerald, sapphire, or burnt orange. Flank the bed with sleek geometric nightstands in matte black with brass hardware and invisible touch-to-open drawers, each topped with sculptural designer table lamps featuring geometric shades. A statement curved accent chair in charcoal velvet with black metal legs sits elegantly near the windows, paired with a minimalist side table with brass details. One accent wall behind the headboard features textured 3D geometric wall panels or high-gloss lacquered finish. A tall sculptural floor lamp with geometric lines stands in a corner. Large-format oversized abstract canvas art with gold leaf details hangs above the headboard. Sheer motorized blackout curtains frame the windows without obscuring them. A plush area rug in concrete grey with subtle geometric pattern grounds the bed. Large-format polished porcelain tiles or seamless resin floors in concrete grey gleam softly. The refined palette consists of monochromatic greys, blacks, and whites with strategic bold jewel-tone accents. Integrated hidden storage with push-to-open mechanisms maintains clean lines. All architectural features including windows and doors remain completely intact and clearly visible",
"Minimalist": "supremely refined minimalist luxury bedroom with museum-quality restraint, bathed in pure diffused natural daylight streaming through the original expansive floor-to-ceiling windows which must remain visible and prominent. Invisible recessed lighting in ceiling coves provides subtle ambient glow. Center the composition around an essential ultra-low-profile platform bed with razor-sharp immaculate lines and weightless visual presence, featuring an integrated floating headboard in pure matte white, dressed with pristine white organic linen bedding with invisible seams and a single soft grey cashmere throw folded geometrically at the foot. Flank the bed with minimal floating wall-mounted nightstands in pure white with completely hidden storage (no visible handles), each topped by a single museum-quality sculptural ceramic table lamp in white. A single essential lounge chair with organic curves in white linen sits near the windows with perfect negative space around it, accompanied by one simple wooden side table in pale oak. One museum-quality sculptural focal-point object (smooth stone sphere or minimal ceramic vessel) sits on a floating shelf. Floor-to-ceiling seamless hidden storage with push-to-open mechanisms lines one wall with invisible integration. Pure white smooth matte walls with invisible baseboards create serene backdrop. Simple sheer white linen curtains frame windows without covering them. Polished concrete or pale wide-plank oak floors in natural finish gleam softly. The monochrome palette consists exclusively of white, soft grey, and pale natural wood tones. Strategic negative space and completely uncluttered surfaces are essential. All architectural features including windows and doors remain completely intact and clearly visible with maximum breathing room",
"Scandinavian": "ultra-refined Scandinavian luxury bedroom with contemporary minimal elegance, bathed in soft diffused natural daylight streaming through the original grand floor-to-ceiling black-framed Crittall-style windows and glass doors which must remain visible and prominent. Warm ambient recessed cove ceiling lighting creates a serene atmosphere. Center the composition around an exquisite platform bed with a sophisticated upholstered linen headboard in warm cream, dressed with premium white bedding, a textured oat-colored throw blanket delicately draped across, and plush pillows in varying textures. Flank the bed with matching light oak nightstands featuring clean minimalist lines and subtle drawer pulls, each topped with elegant textured ceramic table lamps with linen shades. A luxurious ivory bouclé accent chair with wooden legs sits gracefully in a corner near the windows, accompanied by a sculptural natural wood side table. A grand rustic heavily textured organic ceramic floor vase holds a magnificent arrangement of oversized fluffy pampas grass plumes positioned to complement not obstruct the architectural features. A large mature olive tree in an artisan terracotta pot stands elegantly in another corner. On the main wall above the headboard hangs a single large-scale elegant minimalist abstract line-art drawing in a natural oak frame. Sheer flowing linen curtains frame the windows without covering them. A plush textured natural jute or wool area rug in warm beige grounds the bed. The light oak hardwood flooring gleams softly. The refined palette consists of pristine white walls, ivory linens, warm beige and soft oat tones, with organic accents of natural terracotta and muted sage. All furniture pieces exhibit Scandinavian craftsmanship with clean lines and premium materials. The architectural integrity including all windows and glass doors remains completely intact and clearly visible",
"Japanese": "serene zen-inspired Japanese luxury bedroom with wabi-sabi elegance, illuminated by soft diffused natural daylight streaming through the original floor-to-ceiling windows which must remain visible and prominent. Warm ambient paper lantern pendant lights (akari-style) provide gentle evening glow. Center the composition around an ultra-low minimalist platform bed with clean horizontal lines and no visible hardware, featuring a simple upholstered headboard in natural linen or tatami texture in sand tones, dressed with premium organic cotton bedding in muted earth tones with a charcoal grey throw blanket folded precisely. Flank the bed with low lacquered black wooden nightstands with clean minimal lines and hidden drawers, each topped with simple ceramic table lamps in matte white. A low-profile meditation chair or floor cushion (zabuton) in deep moss green sits gracefully near the windows on natural tatami mat. Shoji-inspired translucent sliding panels with black wooden frames create subtle spatial division without blocking windows. A warm natural bamboo accent wall behind the headboard adds organic texture. River stone and white gravel zen garden elements arranged in a shallow ceramic tray sit on a low wooden shelf. A single ikebana flower arrangement in a simple ceramic vase provides the only floral accent. Sliding fusuma doors with subtle nature prints lead to adjacent spaces. A handwoven natural fiber area rug in sand tones grounds the bed. Natural bamboo or light oak flooring gleams softly. The muted wabi-sabi palette consists of sand, clay, charcoal, and deep moss green with forest accents. Serene uncluttered composition with intentional negative space creates tranquil atmosphere. All architectural features including windows remain completely intact and clearly visible",
"Rustic": "warm inviting rustic luxury bedroom with artisanal country elegance, bathed in soft natural daylight streaming through the original floor-to-ceiling windows which must remain visible and prominent. Warm amber Edison filament bulb chandeliers on black iron chains provide intimate evening glow. Center the composition around a magnificent solid reclaimed barn wood bed frame with visible grain, knots, and natural weathering, featuring a tufted linen upholstered headboard in oatmeal, dressed with premium white bedding, chunky cable-knit wool throw in cream, and layered linen pillows. Flank the bed with massive solid wood nightstands with hand-forged wrought iron hardware and visible saw marks, each topped with vintage-inspired table lamps with burlap shades. A distressed cognac leather wingback chair with nailhead trim sits invitingly near the windows, accompanied by a rustic wooden side table. Exposed rough-hewn dark wood ceiling beams with visible texture span overhead. A whitewashed brick or stone accent wall behind the headboard adds organic warmth. Artisanal terracotta pottery and raw stone accents sit on open wooden shelving. An antique wooden ladder leans decoratively against one wall. Wrought iron candelabra wall sconces flank the headboard. A vintage woven jute area rug in natural tones grounds the bed. Wide-plank reclaimed wood flooring in warm honey tones gleams softly. The warm palette consists of oatmeal, cream, cognac leather, terracotta, and weathered wood tones. Layered natural textiles create cozy warmth. All architectural features including windows remain completely intact and clearly visible",
"Industrial": "edgy sophisticated industrial luxury bedroom with urban warehouse character, illuminated by natural daylight streaming through the original floor-to-ceiling black steel-pipe Crittall-style windows which must remain visible and prominent. Oversized cage-style Edison filament pendant lights on fabric-wrapped cords provide dramatic evening glow. Center the composition around a striking welded metal-frame platform bed with rivet details and aged patina, featuring a channel-tufted dark cognac leather headboard, dressed with charcoal grey bedding and a gunmetal grey throw blanket. Flank the bed with riveted metal nightstands with reclaimed wood plank tops and visible weld seams, each topped with industrial cage-style table lamps with Edison bulbs. A dark distressed cognac leather tufted wingback chair sits boldly near the windows, accompanied by a repurposed factory cart side table with metal wheels. Raw exposed red brick accent wall with visible mortar texture and aged patina behind the headboard creates dramatic focal point. Black steel-pipe open shelving with reclaimed wood planks displays vintage industrial objects. Exposed ductwork and conduit piping on ceiling adds authentic warehouse character. A vintage industrial fan sits in one corner. Metal locker-style storage units provide functional storage. A distressed area rug in charcoal with rust orange accents grounds the bed. Polished concrete floors with visible aggregate gleam softly. The dark palette consists of charcoal, gunmetal grey, cognac leather, and rust orange accents. Raw materials and visible construction details create authentic industrial atmosphere. All architectural features including windows and exposed elements remain completely intact and clearly visible",
"Boho": "eclectic vibrant bohemian luxury bedroom with global wanderlust character, bathed in soft natural daylight streaming through the original floor-to-ceiling windows which must remain visible and prominent. Rattan pendant lights with macramé tassels provide warm evening glow. Center the composition around a low curved rattan bed frame with natural texture, featuring a carved wooden headboard with intricate details, dressed with white bedding layered with colorful vintage textiles including suzani embroidered cushions, Moroccan wedding blankets, and Indian block-print throws in jewel tones (ruby, sapphire, emerald). Flank the bed with low wooden nightstands with carved details and brass hardware, each topped with ceramic table lamps in terracotta with patterned shades. A large curved rattan peacock chair sits invitingly near the windows, accompanied by a Moroccan leather pouf in cognac. An oversized macramé wall hanging serves as dramatic focal statement piece above the headboard. Abundant hanging potted plants (pothos, string-of-pearls) cascade from ceiling corners, and a tall fiddle-leaf fig tree in a woven basket stands in one corner. Carved wooden screens create subtle room division without blocking windows. Dreamcatchers and beaded garlands add whimsical touches. Distressed wooden trunks provide storage. Multiple layered colorful vintage Persian and Turkish kilim rugs in jewel tones cover the floor. Natural wood or terracotta tile flooring peeks through. The warm earthy palette consists of terracotta, mustard yellow, burnt orange, sage green, and jewel tones. Eclectic global textiles and abundant plants create bohemian warmth. All architectural features including windows remain completely intact and clearly visible",
"Super Luxury": "opulent museum-quality super luxury bedroom with bespoke sophistication, bathed in soft diffused natural daylight streaming through the original grand floor-to-ceiling windows which must remain visible and prominent. Grand multi-tier crystal chandelier with cascading faceted prisms in aged brass frame provides spectacular ambient glow. Center the composition around an extraordinary king-size bed with custom Italian boiserie integrated headboard wall featuring soft greige paneling with fluted vertical channels and aged brass inlay trim extending floor-to-ceiling, dressed with the finest hand-stitched channel-tufted champagne velvet bedding, silk pillows in dove grey, and a cashmere throw in warm sand beige draped artfully. Flank the bed with museum-quality nightstands in book-matched walnut with aged brass hardware and marble tops, each topped with crystal table lamps with silk shades. A statement curved velvet chaise lounge in soft dove grey with brass legs sits regally near the windows, accompanied by a sculptural smoked glass side table with brass legs. One feature wall showcases bespoke book-matched Calacatta Gold marble with dramatic gold and grey veining in high-gloss finish. A floating linear fireplace with backlit white onyx surround creates a focal point. Large-scale museum-quality black-and-white photography in ornate aged brass frames hangs above side walls. Fresh white orchid arrangements in crystal vases add organic elegance. Floor-to-ceiling silk drapes in champagne with hidden motorized track and blackout lining frame windows without covering them. A plush handwoven silk and wool area rug in ivory with subtle geometric pattern covers most of the floor. Herringbone wide-plank white oak floors in satin finish gleam beneath. Architectural crown molding and coffered ceiling details add dimension. Integrated smart lighting with warm LED strips in crown molding creates ambiance. The sophisticated palette consists of champagne, soft dove grey, warm sand beige, aged brass, and Calacatta marble tones. Leather-wrapped decorative trays with coffee table books add refined details. All architectural features including windows remain completely intact and clearly visible with regal presence",
    };
