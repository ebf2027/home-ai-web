...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  const styleAtmosphere: Record<string, string> = {
    ...
    "Scandinavian":
      "ultra-refined Scandinavian and contemporary minimal luxury atmosphere, bathed in soft, diffused natural daylight from grand expansive floor-to-ceiling black-framed Crittall-style windows and warm recessed cove ceiling lighting. The palette is pure white, warm ivory, soft oat, and natural beige, with touches of terracotta and sage. A grand rustic heavily textured organic ceramic floor vase holds a massive magnificent arrangement of fluffy pampas grass plumes — this vase must always be present. A large mature olive tree in a textured terracotta pot stands nearby. A single elegant minimalist line-art abstract drawing in a natural thin wood frame hangs on the main wall. A minimal full-length mirror leans against a wall. Sheer premium linen curtains in warm ivory are drawn softly over the windows, layered with light beige linen drape panels. A textured natural chunky-weave area rug in warm oat or ivory covers the light wide-plank oak floor",
    "Japanese":
  ...
  const roomElements: Record<string, string> = {
    ...
    "Bedroom":
      "The room must be a bedroom. It must contain: a grand fully upholstered luxury platform bed as the absolute centrepiece — with a tall, generously padded fabric headboard in premium bouclé or fine linen in warm ivory or soft oat, mounted on a solid low-profile base in brushed plaster or upholstered fabric (NOT raw wood). The bed is dressed in multiple layers of the finest premium bedding: a fitted sheet in crisp white Egyptian cotton, a plush duvet with a waffle-knit or jacquard white cover with subtle texture, and at least four oversized pillows in white and ivory with varied textures (linen, bouclé, and cotton), finished with a beautifully draped chunky-knit or waffle-weave throw blanket in warm beige casually folded at the foot of the bed. Two matching minimal light oak or plaster-finish bedside nightstands flank the bed, each holding a textured rustic ceramic table lamp with a linen shade, a small stack of books, and a ceramic mug. A cozy oversized cream bouclé teddy-style luxury lounge armchair sits in the corner with a soft knit throw casually draped over its arm, positioned next to an organically shaped solid wood side stool. A built-in custom light oak wardrobe unit with a mix of open shelves and closed drawers lines one wall. A full-length minimal mirror leans against the wall. There must be NO sofa, NO dining table, NO kitchen island.",
    "Kitchen":
