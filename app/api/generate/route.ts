...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  if (!isExterior) {
    const interiorModifiers: Record<string, string> = {
      ...
      "Scandinavian": "ultra-refined Scandinavian luxury interior, flooded with soft and diffused natural light that creates an ethereal glow, sleek low-profile platform bed with premium ivory linen bedding and a simple beige knit throw, minimalist floating light oak nightstands with small ceramic lamps, a grand textured organic ceramic floor vase holding a massive arrangement of fluffy pampas grass, a second large olive tree in a textured pot, a cozy cream bouclé lounge chair with a folded knit throw next to a minimalist side table, a single elegant minimalist line-art print in a light wood frame above the bed, a full-length leaning floor mirror, sheer linen drapes on black tracks",
