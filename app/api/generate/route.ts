...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  if (r.includes("kitchen"))
    return "wide-plank light oak floors, white matte plaster walls with all original windows fully preserved, white shaker-style cabinetry with brushed brass handles, light oak kitchen island with white quartz countertop, pendant lights in warm white above island, open oak shelving with ceramic dishes and plants, small potted herbs on windowsill, large botanical print in oak frame";
  if (r.includes("dining"))
    return "wide-plank light oak floors, white matte plaster walls with all original windows fully preserved, large solid oak dining table as central focal point, upholstered dining chairs in warm ivory linen, large oatmeal wool area rug under the table, sculptural pendant light in natural materials above the table, open oak sideboard against the wall, tall olive tree in terracotta pot, large botanical line-art print in oak frame";
  if (r.includes("bathroom"))
    return "large format warm white stone tiles on floors and walls with all original windows fully preserved, freestanding oval white bathtub, floating oak vanity with white ceramic basin, large frameless mirror, brushed brass fixtures and towel rail, potted white orchid on vanity, soft linen towels in warm white and oatmeal";
  if (r.includes("office"))
    return "wide-plank light oak floors, white matte plaster walls with all original windows fully preserved, large solid oak desk as central focal point, upholstered desk chair in warm ivory linen, open oak bookshelves against the wall with neatly organized books and ceramic objects, large oatmeal wool area rug, sculptural ceramic table lamp, tall olive tree in terracotta pot";
