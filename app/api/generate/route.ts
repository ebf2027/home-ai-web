...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  if (!isExterior) {
    const interiorModifiers: Record<string, string> = {
      ...
      "Scandinavian": "wide-plank light oak flooring, white matte plaster walls, large windows with natural light wood frames and floor-length sand linen curtains, Nordic minimalist furniture in light oak with clean lines and soft ivory upholstery, neutral monochromatic palette (white, cream, beige, light grey, natural wood), layered natural textiles (linen, wool, cotton) in oatmeal and ivory tones, large natural fiber area rugs, potted indoor greenery in terracotta planters, simple botanical line-art in light wood frames, warm hygge atmosphere",
