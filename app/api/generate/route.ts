...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  if (!isExterior) {
    const interiorModifiers: Record<string, string> = {
      ...
      "Scandinavian": "wide-plank light oak floors, white matte plaster walls with all original windows on all walls fully preserved in their exact positions and sizes, all windows framed by floor-length sand linen curtains, tall padded ivory linen headboard against the wall, white linen bedding with chunky oatmeal knit throw, solid oak nightstands with ceramic lamps, large oatmeal wool area rug under the bed, curved bouclé ivory armchair with oak legs in corner, open oak shelving unit against the wall, tall olive tree in terracotta pot, large botanical line-art print in oak frame",
    ...
    const baseStyleDetails = interiorModifiers[style] ?? "";

const roomTypeOverrides: Record<string, Record<string, string>> = {
  "Scandinavian": {
    "living_room": "wide-plank light oak floors, white matte plaster walls with all original windows on all walls fully preserved in their exact positions and sizes, all windows framed by floor-length sand linen curtains, large light oak frame sofa with thick ivory linen cushions as central focal point, round solid oak coffee table, large oatmeal wool area rug anchoring the seating area, curved bouclé ivory armchair with oak legs, open oak shelving unit against the wall, tall olive tree in terracotta pot, large botanical line-art print in oak frame, ceramic table lamp on side table",
    "kitchen": "wide-plank light oak floors, white matte plaster walls with all original windows fully preserved, white shaker-style cabinetry with brushed brass handles, light oak kitchen island with white quartz countertop, pendant lights in warm white above island, open oak shelving with ceramic dishes and plants, small potted herbs on windowsill",
    "bathroom": "large format warm white stone tiles on floors and walls with all original windows fully preserved, freestanding oval white bathtub, floating oak vanity with white ceramic basin, large frameless mirror, brushed brass fixtures and towel rail, potted white orchid on vanity, soft linen towels in warm white and oatmeal",
    "office": "wide-plank light oak floors, white matte plaster walls with all original windows fully preserved, large solid oak desk as central focal point, upholstered desk chair in warm ivory linen, open oak bookshelves against the wall, large oatmeal wool area rug, sculptural ceramic table lamp, tall olive tree in terracotta pot",
    "balcony": "light oak decking floors, white matte walls with all original openings fully preserved, compact oak outdoor sofa with thick ivory cushions, round oak side table, potted olive trees and lavender in terracotta pots, outdoor linen curtains in warm sand, warm string lights overhead",
    "home_theater": "wide-plank light oak floors, white matte plaster walls with all original windows fully preserved, large comfortable sofa in warm ivory bouclé fabric as central focal point, large projection screen or TV on main wall, soft recessed warm lighting in ceiling, large oatmeal wool area rug, oak side tables with ceramic lamps, acoustic panels in natural linen finish on walls",
    "store": "wide-plank light oak floors, white matte plaster walls with all original windows fully preserved, clean open oak display shelving units along walls, minimalist oak display tables as central focal points, warm recessed spotlights highlighting products, large oatmeal wool area rug defining the main display area, tall olive tree in terracotta pot as decorative anchor",
    "other": "wide-plank light oak floors, white matte plaster walls with all original windows on all walls fully preserved in their exact positions and sizes, all windows framed by floor-length sand linen curtains, solid oak furniture, large oatmeal wool area rug, curved bouclé ivory armchair, open oak shelving unit, tall olive tree in terracotta pot, large botanical line-art print in oak frame",
  },
};

const styleOverride = roomTypeOverrides[style]?.[roomType];
interiorStyleDetails = styleOverride ? `, featuring ${styleOverride}` : `, featuring ${baseStyleDetails}`;
  }
