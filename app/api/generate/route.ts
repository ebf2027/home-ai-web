...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  if (!isExterior) {
    const interiorModifiers: Record<string, string> = {
      ...
      "Scandinavian": "ultra-refined Scandinavian contemporary minimal luxury bedroom, strictly preserving the original architectural structure, proportions, perspective, and exact placement of all floor-to-ceiling glass doors and black-framed windows. The space maintains the original layout while being elevated with high-end Nordic interior design. Soft diffused natural daylight floods through the existing expansive glass openings, combined with warm indirect recessed ceiling lighting, creating depth and realism. Features a premium low-profile upholstered bed with an oversized refined headboard in bouclé or fine linen, styled with layered luxury bedding including linen, cashmere throws, and plush pillows in neutral tones. Introduce a sculptural high-end lounge chair with soft organic curves, and elegant minimal wooden bedside tables with curated decor. Light natural oak flooring is preserved or enhanced, complemented by a large textured wool rug with subtle tonal variation. A handcrafted organic ceramic floor vase with abundant pampas grass stands as a focal element, alongside a mature olive tree in a textured terracotta pot. A single refined minimalist line-art artwork in a natural wood frame decorates the wall, and a full-height thin-frame mirror leans subtly. Sheer linen curtains softly diffuse the light without blocking any windows or doors. Walls remain clean with subtle natural texture, preserving realism without over-smoothing. Color palette: white, ivory, warm beige, oat, soft taupe, with accents of natural wood, terracotta, and muted sage. Hyper-realistic architectural photography, ultra-detailed, 8k, global illumination, physically accurate materials, soft shadows, editorial interior design magazine quality. Do not alter, remove, or reposition any structural elements, windows, or doors from the original image",
