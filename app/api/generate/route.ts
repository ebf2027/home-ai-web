...
function buildPrompt(styleRaw: string, roomTypeRaw: string) {
  ...
  return [
    ...
    `Add ${style} style ${elements} while keeping all existing architectural elements.`,
